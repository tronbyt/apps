...
load("images/league_image.png", LEAGUE_IMAGE_ASSET = "file")
load("images/league_image_small.png", LEAGUE_IMAGE_SMALL_ASSET = "file")
...
load("images/tbd.png", TBD_ASSET = "file")
...
LEAGUE_IMAGE = LEAGUE_IMAGE_ASSET.readall()
LEAGUE_IMAGE_SMALL = LEAGUE_IMAGE_SMALL_ASSET.readall()
NO_OUT = NO_OUT_ASSET.readall()
OCCUPIED_BASE_IMG = OCCUPIED_BASE_IMG_ASSET.readall()
OUT = OUT_ASSET.readall()
TBD = TBD_ASSET.readall()
