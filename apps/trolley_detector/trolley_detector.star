    ...
    for i in result.get("bus"):
        ...
        output = render.Column(
            children = [
                render.Row(
                    children = [
                        render.Box(width = 39 * scale, height = 14 * scale, child = render.Image(src = TROLLEY_IMAGE)),
        ...
        return render.Root(
            child = render.Column(
                children = [
                    render.Row(
                        children = [
                            render.Box(width = 64 * scale, height = 14 * scale, child = render.Image(src = TROLLEY_IMAGE)),
                        ],
                    ),
