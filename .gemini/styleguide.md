...
Every app must contain a preview image named "{app}.webp" in the app directory. Ideally, it should also have a 2x preview named "{app}@2x.webp". These images should be 64x32 and 128x64 pixels, respectively. They are ideally generated by `pixlet render -z 9` and `pixlet render -z 9 -2` commands.
